...
(function(exports) {
  ...
  var interactiveMaybe = function (__dict_Show_8) {
      return new Interactive(defaultCreateUI(Data_Maybe.showMaybe(__dict_Show_8)));
  };
  var interactiveNumber = new Interactive(defaultCreateUI(Prelude.showNumber));
  var createUI = function (dict) {
      return dict.createUI;
  };
  var flareCheck$prime = function (__dict_Interactive_11) {
      return function (parentId) {
          return function (title) {
              return function (x) {
                  var flare = createUI(__dict_Interactive_11)(Prelude.pure(Flare.applicativeUI)(x));
                  return function __do() {
  ...
  var interactiveFunction = function (__dict_Flammable_13) {
      return function (__dict_Interactive_14) {
          return new Interactive(function (f) {
              return createUI(__dict_Interactive_14)(Prelude["<*>"](Flare.applyUI)(f)(spark(__dict_Flammable_13)));
          });
      };
  };
