...
(function(exports) {
  ...
  var flammableTuple = function (dictFlammable) {
      return function (dictFlammable1) {
          return new Flammable(new Data_NonEmpty.NonEmpty(new Data_Tuple.Tuple(head(examples(dictFlammable)), head(examples(dictFlammable1))), Data_List_Types.Nil.value), function (v) {
  ...
  exports["genericSmallNumber"] = genericSmallNumber;
  ...
  exports["flammableList"] = flammableList;
...
(function(exports) {
  ...
  var testFromEnum = function (v) {
      ...
      throw new Error("Failed pattern match at Test.Main line 46, column 1 - line 47, column 1: " + [ v.constructor.name ]);
  };
  var genericTestEnum = new Data_Generic.Generic(function (v) {
      ...
      throw new Error("Failed pattern match at Test.Main line 41, column 8 - line 41, column 51: " + [ v.constructor.name ]);
  });
  var showTestEnum = new Data_Show.Show(Data_Generic.gShow(genericTestEnum));
  var flammableTRegex = new Sparkle.Flammable(new Data_NonEmpty.NonEmpty(Data_Either.fromRight()(Data_String_Regex.regex("fo+")(Data_String_Regex.parseFlags("g"))), Data_List_Types.Nil.value), function (v) {
  ...
  var ordTestEnum = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at Test.Main line 58, column 8 - line 58, column 43: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  ...
  var main = function __do() {
      ...
      Sparkle["sparkle'"](Sparkle.interactiveFunction(Sparkle.flammableString)(Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableString))(Sparkle.interactiveString)))("tests1")("joinWith")(Data_String.joinWith)();
      Sparkle["sparkle'"](Sparkle.interactiveFunction(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.interactiveRecordInstance()(Sparkle.prettyPrintRowListCons(Data_Generic.genericArray(Data_Generic.genericInt))(Sparkle.prettyPrintRowListCons(Data_Generic.genericArray(Data_Generic.genericInt))(Sparkle.prettyPrintRowListNil)(Type_Row.rowLacks()()()(Type_Row.rowLacking))()()(new Data_Symbol.IsSymbol(function () {
          return "yes";
      ...
      var mixHSL = Color.mix(Color.HSL.value);
      Sparkle["sparkleDoc'"](Sparkle.interactiveFunction(Sparkle.flammableColor)(Sparkle.interactiveFunction(Sparkle.flammableColor)(Sparkle.interactiveFunction(Sparkle.flammableSmallNumber)(Sparkle.interactiveColor))))("testsDoc")("mixHSL :: Color -> Color -> Number -> Color")(Data_Maybe.Just.create("Mix two colors by linearly interpolating between them in the HSL color space. " + "The shortest path is chosen along the circle of hue values."))(function (c1) {
          return function (c2) {
              return function (v) {
                  return mixHSL(c1)(c2)(v);
              };
          };
      })();
      ...
      fc(Sparkle.interactiveFunction(Sparkle.flammableRecord()(Sparkle.flammableListCons(Sparkle.flammableArray(Sparkle.flammableInt))(Sparkle.flammableListCons(Sparkle.flammableBoolean)(Sparkle.flammableListCons(Sparkle.flammableNumber)(Sparkle.flammableListCons(Sparkle.flammableMaybe(Sparkle.flammableChar))(Sparkle.flammableListCons(Sparkle.flammableString)(Sparkle.flammableListNil)(Type_Row.rowLacks()()()(Type_Row.rowLacking))()()(new Data_Symbol.IsSymbol(function () {
          return "str";
      })))(Type_Row.rowLacks()()()(Type_Row.rowLacking))()()(new Data_Symbol.IsSymbol(function () {
          return "optional";
      })))(Type_Row.rowLacks()()()(Type_Row.rowLacking))()()(new Data_Symbol.IsSymbol(function () {
          ...
          return "arr";
      })))))("Record")(Control_Category.id(Control_Category.categoryFn))();
